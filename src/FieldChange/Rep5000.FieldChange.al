report 50000 "TTT-PR FieldChange"
{
        ...
        layout
        {
            area(Content)
            {
                group(Settings)
                {
                    ...
                    {
                        Caption = 'Action';
                        ToolTip = 'Action "ModifyValidate" is used for validating the current field content and/or just running the OnModify.';
                        ApplicationArea = All;
                    }
    ...
    var
        ...
        txtTableName: Text;
        txtFieldName: Text;
        optAction: Option "ClearValue","InitValue","SetValue","ModifyValidate";
    ...
    begin
        ...
        repeat
            ...
            if optAction = optAction::ModifyValidate then
                locfrNew := locfrField;
